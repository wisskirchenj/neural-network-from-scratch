...
class InitializationTest(unittest.TestCase):
    ...
    def test_xavier_1dim(self):
        result = xavier(1, 2, 3042022).flatten().tolist()
        self.assertEqual(2, len(result))
        self.assertListEqual([-1.3834172431039413, 0.6420579432446958], result)

    def test_xavier_limit(self):
        result = xavier(2, 2, 0).flatten().tolist()
